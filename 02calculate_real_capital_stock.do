...
sort firm
save capital.05.dta, replace

use capital.05.dta, clear
...
use capital.05.dta, clear
merge firm using capital.20.dta
drop _merge
...
shell rm g*.dta
shell rm test.10.dta
shell rm 91.10.dta
shell rm capital.05.dta
shell rm capital.20
